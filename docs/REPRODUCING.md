...
Prerequisites: Node.js and a MoonBit toolchain. No npm packages or paid services
...
and runs the square-root example. A nonzero exit means verification failed.
